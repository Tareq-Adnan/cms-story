	...
	<div class="app-content pt-3 p-md-3 p-lg-4">
		<div class="container-xl">
			<div class="row g-3 mb-4 align-items-center justify-content-between">
				<div class="col-auto">
					<h1 class="app-page-title mb-0">Pending User Request</h1>
				</div>
										...
										<div class="dropdown">
											...
											<ul class="dropdown-menu">
												<li><a class="dropdown-item"
														href="../post.php?view=<?php echo $user_id ?>"><svg width="1em"
												...
												<li><a class="dropdown-item"
														href="pending-user.php?accept=<?php echo $user_id ?>"><svg
															xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
															fill="currentColor" class="bi bi-person-check me-2"
															viewBox="0 0 16 16">
															<path
												...
												<li><a class="dropdown-item"
														href="pending-user.php?reject=<?php echo $user_id ?>"><svg
															xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
															fill="currentColor" class="bi bi-person-slash me-2"
															viewBox="0 0 16 16">
															<path
												...
												<li><a class="dropdown-item" href="pending-user.php?delete=<?php echo $user_id ?>"><svg width="1em" height="1em"
