	...
	<div class="app-content pt-3 p-md-3 p-lg-4">
		<div class="container-xl">
			<div class="row g-3 mb-4 align-items-center justify-content-between">
				<div class="col-auto">
					<h1 class="app-page-title mb-0">Rejected Posts</h1>
				</div>
				...
				<div class="row g-4">
					...
					$query = "SELECT * FROM users WHERE status='rejected' LIMIT $page_1,8";
		...
		<nav class="app-pagination mt-5">
			<ul class="pagination justify-content-center">
				...
				for ($i = 1; $i <= $num; $i++) {
					?>
					<li class="page-item active"><a class="page-link" href="rejected.php?page=<?php echo $i ?>"><?php echo $i ?></a>
					</li>
