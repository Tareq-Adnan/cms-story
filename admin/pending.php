	...
	<div class="app-content pt-3 p-md-3 p-lg-4">
		<div class="container-xl">
			<div class="row g-3 mb-4 align-items-center justify-content-between">
				<div class="col-auto">
					<h1 class="app-page-title mb-0">Pending Posts</h1>
				</div>
										...
										<div class="dropdown">
											...
											<ul class="dropdown-menu">
												<li><a class="dropdown-item"
														href="../post.php?view=<?php echo $post_id ?>"><svg width="1em"
												...
												<li><a class="dropdown-item"
														href="pending.php?publish=<?php echo $post_id ?>&p"><svg width="1em"
															height="1em" viewBox="0 0 16 16" class="bi bi-eye me-2"
															fill="currentColor" xmlns="http://www.w3.org/2000/svg">
															<path fill-rule="evenodd"
																d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8zM1.173 8a13.134 13.134 0 0 0 1.66 2.043C4.12 11.332 5.88 12.5 8 12.5c2.12 0 3.879-1.168 5.168-2.457A13.134 13.134 0 0 0 14.828 8a13.133 13.133 0 0 0-1.66-2.043C11.879 4.668 10.119 3.5 8 3.5c-2.12 0-3.879 1.168-5.168 2.457A13.133 13.133 0 0 0 1.172 8z" />
												...
												<li><a class="dropdown-item"
														href="../edit-post.php?edit=<?php echo $post_id ?>"><svg width="1em"
		...
		<nav class="app-pagination mt-5">
			<ul class="pagination justify-content-center">
				...
				for ($i = 1; $i <= $num; $i++) {
					?>
					<li class="page-item active"><a class="page-link" href="posts.php?page=<?php echo $i ?>"><?php echo $i ?></a>
					</li>
