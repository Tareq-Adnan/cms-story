        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="add-post">
                <div class="add_post_field">
                    <input type="text" name="title" placeholder="গল্পের শিরোমাম" class="" required>
                </div>
                ...
                <div class="add_post_field">
                    <input type="text" placeholder="গল্পের ট্যাগ" name="tag" class="" required>
                </div>


                <div class="add_post_field">
                    <label for="category">গল্পের ধর</label> <br>
                    <select class="dropdown" name="category" id="" required>
                        <?php selectCat(); ?>
